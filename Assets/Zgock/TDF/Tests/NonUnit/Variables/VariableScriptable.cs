...
using UnityEngine;
[CreateAssetMenu(fileName = "VariableScriptable", menuName = "TDF/Test/VariableScriptable", order = 1)]
public class VariableScriptable : ScriptableObject,IVariables
{
    [SerializeField] public TDFVariables variables = new();
    ...
    //[SerializeField]public TDFDictionary<string,BoolVar> boolvars = new();
    //[SerializeField]public TDFDictionary<string,IntVar> intvars = new();
    //[SerializeField]public TDFDictionary<string,FloatVar> floatvars = new();
    //[SerializeField]public TDFDictionary<string,StringVar> stringvars = new();
    //[SerializeField]public TDFDictionary<string,Vector3Var> vector3vars = new();
    //[SerializeField]public TDFDictionary<string,QuaternionVar> quaternionvars = new();
